...
Измените дефолтные значения переменных в [.env файле](https://docs.testit.software/installation-guide/ustanovka-perezapusk-i-udalenie-v-docker-compose/opisanie-.env-faila).

Задайте параметры vm.max\_map\_count=262144 и vm.overcommit\_memory=1:
...
Опционально: включите [логирование пользовательских действий](https://docs.testit.software/installation-guide/logirovanie-polzovatelskikh-deistvii). По умолчанию оно отключено.
