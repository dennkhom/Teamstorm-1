...
Черновики отображаются на панели навигации в разделе «Страницы» и отмечаются на ней значком с изображением карандаша ![](<../../../.gitbook/assets/изображение (1) (1) (1) (1) (1) (1).png>).
...
1. Наведите курсор на значок с изображением карандаша <img src="../../../.gitbook/assets/изображение (1) (1) (1) (1) (1) (1).png" alt="" data-size="line"> на панели навигации напротив того черновика, который вы хотите удалить и нажмите отобразившуюся кнопку вызова меню.
2. Выберите **Удалить**.
