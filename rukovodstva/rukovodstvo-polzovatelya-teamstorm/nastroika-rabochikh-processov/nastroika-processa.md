...
4. Закройте панель, нажав на **╳**  в правом верхнем углу и нажмите **Сохранить**.

<figure><img src="../../../.gitbook/assets/изображение (1) (1).png" alt=""><figcaption></figcaption></figure>

## Настройка правил при переходах

Настройка правил доступна пользователям, которым выдано соответствующее разрешение на уровне пространства.
...
1. Нажмите на стрелку перехода на схеме процесса.&#x20;
2. В открывшейся слева панели на вкладке **Правила** выберите **Разрешено переводить если заполнены атрибуты:**
3. Раскройте список атрибутов и отметьте чекбоксами нужные атрибуты. &#x20;
4. Закройте панель, нажав на **╳**  в правом верхнем углу и нажмите **Сохранить**.

<figure><img src="../../../.gitbook/assets/изображение (247).png" alt=""><figcaption></figcaption></figure>

Переход, для которого установлено ограничение, будет отмечен на схеме значком <img src="../../../.gitbook/assets/изображение (248).png" alt="" data-size="line">.
