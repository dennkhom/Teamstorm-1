...
Процессы создания и редактирования описаний и комментариев в общих чертах описаны в разделах [Создание задачи](./#sozdanie-zadachi) и [Редактирование задачи](./#redaktirovanie-zadachi).
