...
1. В карточке задачи нажмите на панели инструментов кнопку <img src="../../../../.gitbook/assets/изображение (3).png" alt="" data-size="line"> **Вставить объект**.
...
1. В карточке задачи кликните в поле ввода описания и нажмите кнопку **Открыть** <img src="../../../../.gitbook/assets/изображение (2) (1).png" alt="" data-size="line">справа от объекта.&#x20;
...
В карточке задачи кликните в поле ввода описания и нажмите кнопку **Удалить** <img src="../../../../.gitbook/assets/изображение (3) (1).png" alt="" data-size="line"> справа от объекта.&#x20;
