...
Документ описывает действия системного администратора по установке и настройке ПО TeamStorm v. 2.33.0 и выше в случае, если у вас установлено только ПО Test IT.
