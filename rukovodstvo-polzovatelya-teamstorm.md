...
1. Нажмите ![](<.gitbook/assets/изображение (2).png>) напротив нужного спринта в панели навигации в правой части экрана или в правом верхнем углу в представлени задач выбранного спринта.
2. Измените необходимые данные.
3. Нажмите **Сохранить**.

### Завершение спринта

В представлении задач выбранного спринта нажмите **Завершить спринт** в верхней правой части представления.

В открывшемся модальном окне нажмите  **Завершить**.
