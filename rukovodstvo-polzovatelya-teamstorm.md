...
1. Выберите пользователя из списка и нажмите <img src=".gitbook/assets/изображение (2) (1) (1).png" alt="" data-size="line">.
...
Если папка содержит вложенные папки или расширения, то в навигационной панели рядом с названием папки будет отображена кнопка раскрытия вложенных папок <img src=".gitbook/assets/изображение (2).png" alt="" data-size="line">.&#x20;
