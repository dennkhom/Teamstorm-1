...
1. Нажмите кнопку <img src=".gitbook/assets/изображение (1).png" alt="" data-size="line"> в верхнем правом углу экрана запроса и выберите **Переименовать**.
...
1. Нажать  <img src=".gitbook/assets/изображение.png" alt="" data-size="line"> напротив названия запроса в левой части экрана и выберите **Удалить**.
