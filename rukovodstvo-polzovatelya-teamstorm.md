...
4. Закройте панель, нажав <img src=".gitbook/assets/изображение (20).png" alt="" data-size="line"> в правом верхнем углу панели.
...
2.  Нажмите <img src=".gitbook/assets/изображение (1) (1).png" alt="" data-size="line">в открывшейся справа панели (карточке задачи).&#x20;
...
### Создание и редактирование описаний и комментариев к задачам
...
Инструменты форматирования расположены в верхней части поля ввода текста и отображаются при переходе курсора в это поле.&#x20;
