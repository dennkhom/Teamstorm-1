...
2. Измените данные (название, даты, описание спринта).
3. Нажмите **Сохранить**.
...
2.  Нажмите <img src=".gitbook/assets/изображение (1) (1) (4).png" alt="" data-size="line">в открывшейся справа панели (карточке задачи).&#x20;
    ...
    <figure><img src=".gitbook/assets/изображение (2) (7).png" alt=""><figcaption></figcaption></figure>
...
2. Справа от названия задачи, связь с которой требуется удалить, нажмите <img src=".gitbook/assets/изображение (2).png" alt="" data-size="line">.
