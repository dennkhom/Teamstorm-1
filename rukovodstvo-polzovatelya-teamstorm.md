...
1. Выберите в списке тип, который необходимо удалить, и нажмите <img src=".gitbook/assets/изображение (1).png" alt="" data-size="line">.
...
1. Нажмите <img src=".gitbook/assets/изображение (8).png" alt="" data-size="original"> напротив названия пространства или папки, из которых вы хотите сделать выгрузку.
