...
2.  Нажать <img src=".gitbook/assets/изображение (83).png" alt="" data-size="line"> в правом верхнем углу экрана и выбрать **Редактировать команду**.
...
TeamStorm позволяет создавать подробные, структурированные описания и комментарии к задачам благодаря встроенным инструментам форматирования текста. Инструменты форматирования расположены в верхней части поля ввода текста и отображаются при переводе курсора в это поле.
...
2. Справа от названия задачи, связь с которой требуется удалить, нажмите <img src=".gitbook/assets/изображение (109).png" alt="" data-size="line">.
...
<figure><img src=".gitbook/assets/изображение (108).png" alt=""><figcaption></figcaption></figure>
...
2. Нажмите кнопку **Отслеживать** <img src=".gitbook/assets/изображение (164).png" alt="" data-size="line"> в правом верхнем углу карточки задачи.
...
2. Нажмите кнопку **Перестать отслеживать** <img src=".gitbook/assets/изображение (101).png" alt="" data-size="line"> в правом верхнем углу карточки задачи.
