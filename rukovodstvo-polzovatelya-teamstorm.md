...
<figure><img src=".gitbook/assets/изображение (2) (6).png" alt=""><figcaption></figcaption></figure>
...
1. На **Главной странице** в блоке пространств нажмите <img src=".gitbook/assets/изображение (1) (1) (1) (1).png" alt="" data-size="line">.
...
Для быстрого создания задач можно использовать клонирования задачи:

1. Перейдите в карточку задачи, которую нужно клонировать.
2. Нажмите <img src=".gitbook/assets/изображение.png" alt="" data-size="line"> и выберите **Клонировать задачу.**
...
### Просмотр истории создания задачи и изменений атрибутов&#x20;
...
В открывшейся вкладке отображается история создания задачи и изменения атрибутов.
...
Для истории изменений указывается:

* автор изменения;
* какой атрибут был изменен или добавлен;
