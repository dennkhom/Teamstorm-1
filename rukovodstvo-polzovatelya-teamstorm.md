...
1. Нажмите кнопку редактирования <img src=".gitbook/assets/изображение.png" alt="" data-size="line"> в правом верхнем углу экрана, затем выберите **Переименовать**.
2. В открывшемся модельном окне введите новое название портфолио и нажмите **Сохранить**.&#x20;

Для редактирования элемента портфолио:

1. Перейдите в элемент портфолио, который требуется изменить, и нажмите кнопку редактирования <img src=".gitbook/assets/изображение.png" alt="" data-size="line"> в правом верхнем углу экрана, затем выберите **Настроить.**
...
В случае если настроена интеграция с GitLab (или другим провайдером) и системой и успешно разобрано сообщение о создании, изменении или решении запроса на слияние, то можно получить список связей задачи с соответствующей сущностью в GitLab.
