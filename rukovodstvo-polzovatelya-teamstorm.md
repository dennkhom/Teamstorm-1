...
Роли доступа к пространству и их настройка описаны в разделе [#nastroika-rolei-dostupa-k-prostranstvu](rukovodstvo-polzovatelya-teamstorm.md#nastroika-rolei-dostupa-k-prostranstvu "mention").
...
1. Администратор пространства с правами по управлению пространством:
...
2. Пользователь пространства с правами на просмотр и редактирование контента пространства:
   * работа с папками;
...
4. В открывшейся панели введите название роли и настройте права доступа при помощи отметки тех или иных прав в чекбоксах, сгруппированных по функциям.
5. Нажмите **Добавить**.&#x20;
...
* [настройке ролей доступа к пространству](rukovodstvo-polzovatelya-teamstorm.md#nastroika-rolei-dostupa-k-prostranstvu);
...
1. Выберите пользователя из списка и нажмите <img src=".gitbook/assets/изображение (58).png" alt="" data-size="line">.
...
Для удаления задачи из очереди нажмите <img src=".gitbook/assets/изображение (1) (1) (1).png" alt="" data-size="line"> в поле **Спринт** в карточке задачи.
...
2. Нажмите кнопку **Развернуть** <img src=".gitbook/assets/изображение (28).png" alt="" data-size="line"> в правой части экрана.
3. В раскрывшейся справа панели в блоке **ВЛОЖЕНИЯ** выделите курсором нужное вложение.
4. Нажмите отобразившуюся кнопку удаления <img src=".gitbook/assets/изображение (3).png" alt="" data-size="line">.
