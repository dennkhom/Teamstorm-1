...
1. На **Главной странице** в блоке пространств нажмите <img src=".gitbook/assets/изображение (1) (1).png" alt="" data-size="original">.
...
1. Выберите в списке тип, который необходимо удалить, и нажмите <img src=".gitbook/assets/изображение.png" alt="" data-size="line">.
...
1. Выберите в списке тип, который необходимо отредактировать, и нажмите <img src=".gitbook/assets/изображение (1).png" alt="" data-size="line">.
...
4.  В отобразившемся поле начните вводить название задачи, которую нужно связать с текущей.&#x20;
    ...
    6\. Нажмите ![](<.gitbook/assets/изображение (8) (1).png>)
