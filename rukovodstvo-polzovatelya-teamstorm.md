...
5. На открывшейся главной странице системы TestIT нажмите иконку выбора продукта <img src=".gitbook/assets/изображение (3) (3) (1).png" alt="" data-size="original"> в правом верхнем углу экрана.
...
Если папка содержит вложенные папки или расширения, то в навигационной панели рядом с названием папки будет отображена кнопка раскрытия вложенных папок <img src=".gitbook/assets/изображение.png" alt="" data-size="line">.&#x20;

Если папка не содержит вложененых папок или расширений, то кнопка раскрытия не отображается.&#x20;
