...
Роли доступа к пространству и их настройка описаны в разделе [#roli-dostupa-k-prostranstvu](rukovodstvo-polzovatelya-teamstorm.md#roli-dostupa-k-prostranstvu "mention").
...
<figure><img src=".gitbook/assets/изображение (129).png" alt=""><figcaption></figcaption></figure>
...
Для вызова меню нажмите кнопку <img src=".gitbook/assets/изображение (175) (1).png" alt="" data-size="line"> на **Главной панели**.
...
1. Перейдите в [настройки пространства](rukovodstvo-polzovatelya-teamstorm.md#nastroiki-prostranstva);
...
1. Перейдите в [настройки пространства](rukovodstvo-polzovatelya-teamstorm.md#nastroiki-prostranstva);
2. В панели слева выберите **Роли доступа**.
3. Нажмите кнопку удаления <img src=".gitbook/assets/изображение (9).png" alt="" data-size="line"> напротив названия роли, которую необходимо удалить или нажмите на название роли и в открывшейся справа панели нажмите **Удалить**.
...
<figure><img src=".gitbook/assets/изображение (26) (1).png" alt=""><figcaption></figcaption></figure>
...
* [переходах к ранее созданному пространству](rukovodstvo-polzovatelya-teamstorm.md#undefined) по нажатию кнопки ![](<.gitbook/assets/изображение (10) (1).png>) .

<figure><img src=".gitbook/assets/изображение (85) (1).png" alt=""><figcaption></figcaption></figure>
...
* [настройке ролей доступа к пространству](rukovodstvo-polzovatelya-teamstorm.md#dobavlenie-i-nastroika-roli);
* [настройке процессов, которые используются в пространстве](rukovodstvo-polzovatelya-teamstorm.md#nastroika-rabochikh-processov);
...
Далее можно перейти к [присвоению роли добавленному пользователю](rukovodstvo-polzovatelya-teamstorm.md#naznachenie-roli-polzovatelyu-ili-gruppe-polzovatelei).
...
Для исключения пользователя или группы:
...
<figure><img src=".gitbook/assets/изображение (91) (1).png" alt=""><figcaption></figcaption></figure>
...
1. Нажмите <img src=".gitbook/assets/изображение (105).png" alt="" data-size="original"> напротив нужного спринта на панели навигации в правой части экрана или в правом верхнем углу в представлении задач выбранного спринта и выберите **Настроить**.
...
1. Нажмите кнопку редактирования <img src=".gitbook/assets/изображение (1) (2) (1).png" alt="" data-size="line"> в правом верхнем углу экрана, затем выберите **Переименовать**.
2. В открывшемся модельном окне введите новое название портфолио и нажмите **Сохранить**.

Для редактирования элемента портфолио:

1. Перейдите в элемент портфолио, который требуется изменить, и нажмите кнопку редактирования <img src=".gitbook/assets/изображение (1) (2) (1).png" alt="" data-size="line"> в правом верхнем углу экрана, затем выберите **Настроить.**
...
1. На панели навигации слева выберите портфолио, которое требуется удалить, и нажмите кнопку <img src=".gitbook/assets/изображение (176).png" alt="" data-size="line"> или перейдите в портфолио, которое требуется удалить, и нажмите кнопку редактирования в правом верхнем углу экрана, затем выберите **Удалить**.
...
1. На панели навигации слева выберите элемент портфолио, который требуется удалить, и нажмите <img src=".gitbook/assets/изображение (176).png" alt="" data-size="line">
...
<figure><img src=".gitbook/assets/изображение (111).png" alt=""><figcaption><p>Представление «Доска»</p></figcaption></figure>

<figure><img src=".gitbook/assets/изображение (24).png" alt=""><figcaption><p>Представление «Таблица»</p></figcaption></figure>
...
2. Нажмите <img src=".gitbook/assets/изображение (163).png" alt="" data-size="line"> и выберите **Клонировать задачу.**
...
5. Блок "[Запросы на слияние](rukovodstvo-polzovatelya-teamstorm.md#zaprosy-na-sliyanie)" (отображается при настроенной интеграции с GitLab или другим провайдером и установлении связи задачи с соответствующей сущностью провайдера).
6. Блок "Вложения".
...
Для удаления задачи из очереди нажмите <img src=".gitbook/assets/изображение (1) (1) (1) (1).png" alt="" data-size="line"> в поле **Спринт** в карточке задачи.
...
<figure><img src=".gitbook/assets/изображение (73).png" alt=""><figcaption></figcaption></figure>
...
Кроме того выгрузка доступна для сохраненных и выполненных [запросов](rukovodstvo-polzovatelya-teamstorm.md#rabota-s-zaprosami).
...
1. В панели навигации слева нажмите <img src=".gitbook/assets/изображение (36).png" alt="" data-size="line"> напротив названия пространства или папки, из которых вы хотите сделать выгрузку.
...
Подробнее о выгрузке задач или списаний трудозатрат см. выше.
...
3. Введите название страницы в поле **Название**, далее введите или скопируйте нужный текст в  поле редактора. При необходимости воспользуйтесь [инструментами форматирования](rukovodstvo-polzovatelya-teamstorm.md#oformlenie-opisanii-i-kommentariev-k-zadacham).&#x20;
...
3. Отредактируйте название или текст страницы. При необходимости воспользуйтесь [инструментами форматирования](rukovodstvo-polzovatelya-teamstorm.md#oformlenie-opisanii-i-kommentariev-k-zadacham).
...
Для связывания страницы и задачи:
...
Для удаления связи страницы и задачи:
...
Для сохранения вложения на устройство пользователя:
...
Для удаления вложения:

1. Перейдите на страницу, из которой необходимо удалить вложение.
2. Нажмите кнопку **Развернуть** <img src=".gitbook/assets/изображение (28).png" alt="" data-size="line"> в правой части экрана.
3. В раскрывшейся справа панели в блоке **ВЛОЖЕНИЯ** выделите курсором нужное вложение.
4. Нажмите отобразившуюся кнопку удаления <img src=".gitbook/assets/изображение (3) (2).png" alt="" data-size="line">.
