...
Откроется экран формирования запроса. Созданный пустой запрос отображается на панели нафигации всем пользователям пространства в папке, в которой создан запрос.&#x20;

Для формирования запроса:

1.  Выберите расположения задач, из которых требуется сформировать запрос, при помощи фильтра **Расположения**.&#x20;
...
Перейти в созданный запрос можно из панели нафигации, открыв папку, в которой он был создан.
