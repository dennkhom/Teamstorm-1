...
Для вызова меню нажмите кнопку <img src=".gitbook/assets/изображение (11) (2).png" alt="" data-size="line"> на **Главной панели**.
...
1. Выберите пользователя из списка и нажмите <img src=".gitbook/assets/изображение (2) (1) (1) (1) (1).png" alt="" data-size="line">.
...
Если папка содержит вложенные папки или расширения, то в навигационной панели рядом с названием папки будет отображена кнопка раскрытия вложенных папок <img src=".gitbook/assets/изображение (2) (1) (2).png" alt="" data-size="line">.&#x20;
...
3. Напротив расширения **Agile** нажмите кнопку ![](<.gitbook/assets/изображение (2) (4) (1).png>).
...
2.  Нажать <img src=".gitbook/assets/изображение (2) (2) (1).png" alt="" data-size="line"> в правом верхнем углу экрана и выбрать **Редактировать команду**.
...
1. В навигационной панели в левой части экрана найдите портфолио, в котором нужно создать элемент и нажмите **+** напротив его названия.
...
1. В панели навигации слева выберите портфолио, которое требуется удалить, и нажмите <img src=".gitbook/assets/изображение (2) (1).png" alt="" data-size="line">
...
1. В панели навигации слева выберите элемент портфолио, который требуется удалить, и нажмите <img src=".gitbook/assets/изображение (2) (1).png" alt="" data-size="line">
...
Если задача в представлении **Таблица** содержит подзадачи, то рядом с названием задачи располагается кнопка раскрытия списка подзадач <img src=".gitbook/assets/изображение (1) (2).png" alt="" data-size="line">.
...
2. Нажмите <img src=".gitbook/assets/изображение (11) (2) (1).png" alt="" data-size="line"> и выберите **Клонировать задачу.**
...
2. Нажмите кнопку перехода в полноэкранный режим. ![](.gitbook/assets/изображение.png)

Полноэкранная карточка будет открыта в новом окне браузера на весь экран.
...
<figure><img src=".gitbook/assets/изображение (1) (2) (3).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src=".gitbook/assets/изображение (1) (1) (3) (1).png" alt=""><figcaption></figcaption></figure>
...
Запрос — это список задач, которые находятся в разных папках одного представления и объединены опредленными параметрами.&#x20;
...
Запрос создается на уровне папки и по умолчанию строится из задач этой папки, включая ее подпапки.&#x20;

Для создания запроса:

1. Нажмите кнопку <img src=".gitbook/assets/изображение (48).png" alt="" data-size="line"> напротив названия папки, в которой требуется создать запрос и выберите **Создать запрос**.&#x20;
...
1. Нажмите кнопку <img src=".gitbook/assets/изображение (1) (1).png" alt="" data-size="line"> в верхнем правом углу экрана запроса и выберите **Переименовать**.
...
1. Нажать  <img src=".gitbook/assets/изображение (6).png" alt="" data-size="line"> напротив названия запроса в левой части экрана и выберите **Удалить**.
