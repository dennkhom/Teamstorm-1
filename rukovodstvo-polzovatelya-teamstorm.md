...
<figure><img src=".gitbook/assets/изображение (10).png" alt=""><figcaption><p>Представление «Доска»</p></figcaption></figure>
...
1. Откройте [представление задач](rukovodstvo-polzovatelya-teamstorm.md#predstavlenie-zadach) в выбранной папке.
2. Нажмите на нужную задачу.
3.  В открывшейся справа карточке задачи в блоке **СВЯЗАННЫЕ ЗАДАЧИ** нажмите **Добавить**.
