...
В случае если настроена интеграция с GitLab (или другим провайдером) и системой, а описание и/или заголовок запроса на слияние в GitLab содержит номер задачи, то системой будет успешно разобрано сообщение о создании, изменении или решении запроса на слияние и будет сформирован список связей задачи с соответствующей сущностью в GitLab.
...
1. Нажмите <img src=".gitbook/assets/изображение (113).png" alt="" data-size="line"> напротив названия пространства или папки, из которых вы хотите сделать выгрузку.
...
1. Нажмите <img src=".gitbook/assets/изображение (36).png" alt="" data-size="line"> напротив названия пространства или папки, из которых вы хотите сделать выгрузку.
