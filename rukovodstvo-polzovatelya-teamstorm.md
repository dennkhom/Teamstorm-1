...
Для запросов доступна [выгрузка данных](rukovodstvo-polzovatelya-teamstorm.md#vygruzka-dannykh) о задачах и о списаниях трудозатрат.
...
<figure><img src=".gitbook/assets/изображение.png" alt=""><figcaption><p>Запрос на слияние в GitLab</p></figcaption></figure>
...
1. Нажмите <img src=".gitbook/assets/изображение (113).png" alt="" data-size="line"> напротив названия пространства, запроса или папки, из которых вы хотите сделать выгрузку.
...
1. Нажмите <img src=".gitbook/assets/изображение (36).png" alt="" data-size="line"> напротив названия пространства, запроса или папки, из которых вы хотите сделать выгрузку.
