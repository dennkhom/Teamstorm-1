...
1. Нажмите <img src=".gitbook/assets/изображение (105).png" alt="" data-size="original"> напротив нужного спринта в панели навигации в правой части экрана или в правом верхнем углу в представлении задач выбранного спринта и выберите **Настроить**.
...
1. Нажмите <img src=".gitbook/assets/изображение (105).png" alt="" data-size="line"> напротив нужного спринта в панели навигации в правой части экрана или в правом верхнем углу в представлении задач выбранного спринта.
2. Нажмите **Удалить**.
...
* `Просроченные задачи в работе` — количество задач, у которых **resolveDate** пустое, при этом **dueDate < текущей даты;**
* `Задач в срок` — количество задач, у которых **resolveDate** пустое, при этом **dueDate > текущей даты;**
...
1. В панели навигации слева выберите портфолио, которое требуется удалить, и нажмите <img src=".gitbook/assets/изображение (176).png" alt="" data-size="line">
...
1. В панели навигации слева выберите элемент портфолио, который требуется удалить, и нажмите <img src=".gitbook/assets/изображение (176).png" alt="" data-size="line">
...
2.  Нажмите <img src=".gitbook/assets/изображение (81).png" alt="" data-size="line">в открывшейся справа панели (карточке задачи).&#x20;
...
1. Откройте [представление задач](rukovodstvo-polzovatelya-teamstorm.md#predstavlenie-zadach) в выбранной папке.
2. Нажмите на нужную задачу.
3. В открывшейся справа панели нажмите кнопку создания ссылки ![](<.gitbook/assets/изображение (41).png>)в правом верхнем углу.
