...
1. Нажмите кнопку редактирования <img src=".gitbook/assets/изображение (1) (2).png" alt="" data-size="line"> в правом верхнем углу экрана, затем выберите **Переименовать**.
2. В открывшемся модельном окне введите новое название портфолио и нажмите **Сохранить**.&#x20;

Для редактирования элемента портфолио:

1. Перейдите в элемент портфолио, который требуется изменить, и нажмите кнопку редактирования <img src=".gitbook/assets/изображение (1) (2).png" alt="" data-size="line"> в правом верхнем углу экрана, затем выберите **Настроить.**
...
<figure><img src=".gitbook/assets/изображение (1).png" alt=""><figcaption><p>Запрос на слияние в GitLab</p></figcaption></figure>

<figure><img src=".gitbook/assets/изображение (1) (2) (1).png" alt=""><figcaption><p>Блок "Запрос на слияние" в системе</p></figcaption></figure>
