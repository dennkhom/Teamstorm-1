...
5. Блок "Вложения".
6. Блок комментариев и отображения истории изменения атрибутов.
...
### Просмотр истории изменений атрибутов задачи

1. Открыть [Карточку задачи](rukovodstvo-polzovatelya-teamstorm.md#kartochka-zadachi).
2. Перейти в блок комментариев и![](<.gitbook/assets/изображение (1).png>) истории изменения атрибутов в нижней части карточки и перейти на вкладку **История.**

В открывшейся вкладке отображается история изменений атрибутов, а также указывается автор, дата и время изменения.&#x20;
