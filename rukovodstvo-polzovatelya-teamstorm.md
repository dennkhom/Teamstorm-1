...
1. Выберите в списке тип, который необходимо удалить, и нажмите <img src=".gitbook/assets/изображение (162).png" alt="" data-size="line">.
...
1. Выберите в списке атрибут, который необходимо удалить, и нажмите <img src=".gitbook/assets/изображение (162).png" alt="" data-size="line">.
...
1. На панели навигации слева выберите портфолио, которое требуется удалить, и нажмите <img src=".gitbook/assets/изображение (176).png" alt="" data-size="line">
...
2.  Нажмите <img src=".gitbook/assets/изображение (81).png" alt="" data-size="line">на открывшейся справа панели (карточке задачи).&#x20;
...
Для удаления задачи из очереди нажмите <img src=".gitbook/assets/изображение (1).png" alt="" data-size="line"> в поле **Спринт** в карточке задачи.
