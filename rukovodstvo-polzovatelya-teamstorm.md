...
5. На открывшейся главной странице системы TestIT нажмите иконку выбора продукта <img src=".gitbook/assets/изображение.png" alt="" data-size="original"> в правом верхнем углу экрана.
...
Таблица представляет собой список задач с ее параметрами. Доска представляетсобой набор карточек задач, сгруппированных по статусам в колонках доски.
...
2. В отобразившемся меню выберите оператор фильтрации:
   * Равен - будут отображены задачи со значениями, равными выбранным на следующем шаге;
   * Не равен - будут отображены все задачи, кроме задач со значениями, выбранными на следующем шаге;
   * Заполнен - будут отображены задачи, у которых выбранный на следующем шаге параметр заполнен любым значением (для параметров "Тип" и "Процессы");
   * Не заполнен - будут отображены задачи, у которых выбранный на следующем шаге параметр не заполнен каким-либо значением (для параметров "Тип" и "Процессы").
3. Выберите значения параметра, по которым будет производиться фильтрация.&#x20;
