...
Кроме того в представлении «Доска» по умолчанию доступна фильтрация по параметру
...
3. В отобразившемся меню выберите оператор фильтрации:
   ...
   * Заполнен - будут отображены задачи, у которых выбранный параметр заполнен любым значением;
   * Не заполнен - будут отображены задачи, у которых выбранный параметр не заполнен каким-либо значением;
...
<figure><img src=".gitbook/assets/изображение (5) (6).png" alt=""><figcaption></figcaption></figure>
...
1. Откройте [представление задач](rukovodstvo-polzovatelya-teamstorm.md#predstavlenie-zadach) в выбранной папке.
2. Нажмите на нужную задачу.
3. В открывшейся справа панели нажмите кнопку создания ссылки ![](<.gitbook/assets/изображение (2).png>)в правом верхнем углу.
