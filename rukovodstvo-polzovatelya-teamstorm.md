...
3.  Напротив расширения **Agile** нажмите
    ...
    * кнопку вызова меню ![](<.gitbook/assets/изображение (8) (4) (1).png>), затем выберите **Добавить спринт**
...
1. Нажмите <img src=".gitbook/assets/изображение (2) (5).png" alt="" data-size="original"> напротив нужного спринта в панели навигации в правой части экрана или в правом верхнем углу в представлении задач выбранного спринта и выберите **Настроить**.
...
1. Откройте [представление задач](rukovodstvo-polzovatelya-teamstorm.md#predstavlenie-zadach) в выбранной папке.
2. Нажмите на нужную задачу.
3. В открывшейся справа панели нажмите кнопку создания ссылки ![](<.gitbook/assets/изображение (2) (2).png>)в правом верхнем углу.
