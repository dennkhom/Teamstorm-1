...
Невозможено перемещение в следующих случаях:
...
2.  Нажмите <img src=".gitbook/assets/изображение (1).png" alt="" data-size="line">в открывшейся справа панели (карточке задачи).&#x20;
...
Для удаления задачи из очереди нажмите <img src=".gitbook/assets/изображение (4).png" alt="" data-size="line"> в поле **Спринт** в карточке задачи.
