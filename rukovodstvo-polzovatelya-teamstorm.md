...
3. Выберите нужное расширение, например, **Включить Agile**.

В случае выбора расширения **Agile** для выбранной папки будет автоматически создана очередь **Backlog**.
...
3.  Напротив расширения **Agile** нажмите
    ...
    * кнопку ![](<.gitbook/assets/изображение (2).png>).
