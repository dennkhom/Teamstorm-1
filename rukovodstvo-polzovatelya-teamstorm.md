...
Если папка содержит вложенные папки или расширения, то в навигационной панели рядом с названием папки будет отображена кнопка раскрытия вложенных папок ![](.gitbook/assets/изображение.png).&#x20;
