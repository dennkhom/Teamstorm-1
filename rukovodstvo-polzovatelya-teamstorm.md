...
5. В открывшемся окне введите название процесса в поле в верхней части экрана и назначьте процессу статусы, нажав ![](<.gitbook/assets/изображение (6).png>) в блоках статусов.
6. Нажмите **Сохранить.**
