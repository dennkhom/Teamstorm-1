...
2. При необходимости при помощи навигационных кнопок ![](<.gitbook/assets/изображение (7) (4).png>) разверните список расширений и очередей выбранной папки.
...
<figure><img src=".gitbook/assets/изображение (7).png" alt=""><figcaption><p>Представление  «Таблица»</p></figcaption></figure>
...
Если применены фильтры или поле поиска, то отображаются два числа:

* количество задач, соответствующее результатам фильтрации, на всех уровнях вложенности;
