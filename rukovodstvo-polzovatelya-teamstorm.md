...
Для фильтрации задач по статусу:

1. Нажмите название фильтра **Статус**.
2. В отобразившемся меню выберите оператор фильтрации:
   * Равен - будут отображены статусы, равные выбранному на следующем шаге;
   * Не равен - будут отображены все статусы. кроме выбранного на следующем шаге.&#x20;
3. Выберите статус, по которому будет производиться фильтрация.&#x20;
4. Для закрытия меню щелкните на любое место на экране представления.

<figure><img src=".gitbook/assets/изображение (1).png" alt=""><figcaption></figcaption></figure>

На экране представления будут отображены задачи, отфильтрованные по соответствующим статусам.&#x20;
